...
We selected 16 sites in the southwest of the iberian peninsula (Huelva and Seville) for the samplings. This sites were selected from “pristine” sites to very modified sites having crops and houses nearby (Table S.X). All sites were selected only if they had enough flowering plants that could attract pollinators (Cistus sp., Lavandula sp., Rosmarinus officinalis, Myrtus communis).

We used pollinators because is a system that [...]
All the pollinators were collected and noted in 2015 from March to June using three data collection techniques. The samplings were divided by seven rounds, each round consisted in sampling each one of the 16 sites once by three types of census. The first census was the linear transects. We went through a 100 m straight line during 30 minutes in which we wrote down every plant-pollinator interaction seen. Those bees and plants that we were unable to identify were collected by hand-netting. The second type of census was the focal census. We selected plants with enough flowers from the key species descripted before and we did 5 minutes census in which we wrote down every interaction seen, also capturing species unable to identify from the naked eye for later identification. Finally, to complete the census for the site, we also did an out of transect census, depending on the availability seen of pollinators in the previous censuses and flowers, in which we walked around flower patches to identify and capture unidentified species
